...
| `docs/11_会話解釈SSOT.md` | 会話解釈アーキテクチャ（Phase A: Unified Intent Schema、日付/食事区分解決ルール）（**v2.0正本**） |
| `docs/12_記録確認フローSSOT.md` | 記録確認フロー（Phase B: 明確化、Phase C: 永続化、修正フロー）（**v2.0正本**） |
...
| 会話解釈設計 | `docs/11_会話解釈SSOT.md` | Phase A/B/C アーキテクチャ、Intent Schema、日付/食事区分解決ルール |
| 記録確認フロー | `docs/12_記録確認フローSSOT.md` | 明確化フロー、永続化レイヤー、修正フロー |
